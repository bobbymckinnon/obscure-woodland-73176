...
class EbayProductDataTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function test_processData()
    {
        ...
        $service = new EbayProductData();
        $response = $service->processData(json_decode(self::RESPONSE), $params);

        $this->assertEquals('110371953291', $response->first()->itemId[0]);
    }
}
